...
function CategoryCard({ category, index }: CategoryCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative h-full will-change-transform transform-gpu"
      role="article"
    ...
    >
      ...
      <div className="relative h-full rounded-2xl bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 
